...
\subsection{Solution}
  ...
  \begin{figure}[h!]
    \begin{center}
      \subfigure[Object 1]{\includegraphics[width=0.33\textwidth]{exam1_s2_2} \label{fig:2_free_body_1}}
      \subfigure[Object 2]{\includegraphics[width=0.33\textwidth]{exam1_s2_3} \label{fig:2_free_body_2}}
    \end{center}
